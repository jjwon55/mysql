 ...
 */
 ...
 -- 사원의 급여가 300만원 대 이면, 1소득
 -- 사원의 급여가 400만원 대 이면, 2소득
 -- 사원의 급여가 500만원 대 이면, 3소득
 -- 사원의 급여가 600만원 대 이면, 1소득
 ...
 SELECT
        ...
        CASE 
            ...
            WHEN salary >= 5000000 AND salary < 6000000 THEN '1소득'  
...
-- IF(조건, 참일 때 값, 거짓일때 값)
-- 사원을 조회하여 커미션과 성과금 여불르 함께 출력하시오.

SELECT emp.*
        ,IF(commission_pct IS NULL, '없음', '있음') 커미션유무
        ,IF(bonus IS NOT NULL, '있음', '없음') 성과금유무
